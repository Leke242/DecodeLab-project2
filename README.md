...
**Analyst:** [Your Name] | **Date:** June 29, 2026
...
-   **SAVE10 Underperforms:** Lowest revenue ($274k) and adoption rate, indicating 10% off may not be psychologically compelling enough.

### 3. Critical Risk: Order Failures
-   **40% Failure Rate:** Combined Cancelled (242) + Returned (243) orders represent a massive revenue leak.
...
-   **Outlier Analysis:** Boxplots for visual inspection + IQR method for mathematical flagging.
...
-    Revenue impact by promotional code
...
3.  **Promotion Shift:** Reallocate budget from `SAVE10` to `FREESHIP` campaigns based on superior ROI.
